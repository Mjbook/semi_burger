...
<section>
	<article>
		...
		<div class="div1">
			...
			<span class="subtitle"> HOME > Yong Burger 소개 > CEO 인사말&nbsp;&nbsp;&nbsp;</span>
			<br>
		</div>
		<hr>
		<br>
	...
	<article>
		<ul>
			<li><img src="/semi_burger/introduce/img/hat.png" width="50" height="50"><br>
				<span class="head">YONG BURGER는</span><br>
		...
		<ol>
			<li><span class="head">YONG BURGER는</span> 신선한 재료만 사용합니다.<br>
				<div class="li1">주 재료인 쇠고기, 양상추, 토마토, 양파, 버거번 등 모든 재료는 당일 배송된 신선한 상태의 원재료만 사용하였습니다.</div>
			</li>
			<br>			
