	...
	<div class="maindiv1">
		...
		<ol>
			<li>
				...
				<div>신선한 재료만 사용합니다.<br>
					주 재료인 쇠고기, 양상추, 토마토, 양파, 버거번 등 모든 재료는 당일 배송된 신선한 상태의 원재료만 사용하였습니다.</div>
				<br>
				<br>
			</li>
			<li>			
				<div style="font-size: 24px;">YONG BURGER는</div> 재료비를 아끼지 않습니다.<br>
				<div>버거 패티에 가장 좋은 쇠고기 부위를 사용하고, 모든 야채도 철저한 검수를 통해 질 좋은 상품을 구입하였으며,<br>
			...
			<li>
				...
				<div>버거는 안좋은 음식이라는 편견을 깨기 위해, 패티에 첨가물이나 필러를 넣지 않았고, 모든 메뉴에 인공 조미료 사용을 배제하였으며,<br>
