...
<style>
	...
	.num_rule{
		font-size: 24px;
		color: white;
		background: url(/semi_burger/introduce/img/rule_bg.png) 0% 0% no-repeat;
...
<section>
	...
	<article>
		<div class="maindiv">
			...
			<ol>
				<li>
					<div class="num_rule">YONG BURGER는</div>
					<p>신선한 재료만 사용합니다.<br>
						주 재료인 쇠고기, 양상추, 토마토, 양파, 버거번 등 모든 재료는 당일 배송된 신선한 상태의 원재료만 사용하였습니다.</p>
					<br>
				</li>
				<li>			
					<div class="num_rule">YONG BURGER는</div> 재료비를 아끼지 않습니다.<br>
				...
				<li>
					<div class="num_rule">YONG BURGER는</div> 맛과 함께 건강도 생각합니다.<br>
